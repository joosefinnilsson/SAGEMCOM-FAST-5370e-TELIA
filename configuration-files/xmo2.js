...
$.xmo.err = {
    ...
    XMO_ADD_DUPLICATE_ERR: 16777320
},
$.xmo.init = function() {
    $.gui.init("en", "gtw")
}
...
a.downloadFile($.xpaths.mySagemcomBox.maintenance.saveRestore.save, function() {}, function(a) {}),
    a.send()
}
;
...
$.xmo.restoreConfiguration = function(a) {
    ...
    return $.config.modules.restoreConfigurationAllBackup === !0 ? b.uploadSpecificFile($.xpaths.mySagemcomBox.maintenance.saveRestore.restore, $(a), 1, !0, function(a) {}, function(a) {}) : 
b.uploadFile($.xpaths.mySagemcomBox.maintenance.saveRestore.restore, $(a), function(a) {}, function(a) {
        validRestoreFile = !1
    }),
    b.send(),
    validRestoreFile
    ...
    var f = []
      ...
      , h = function(b) {
        ...
        if (g) {
            ...
            g.code === $.xmo.err.XMO_REQUEST_ACTION_ERR ? $.xmo.logger.warn('XMO getValue request action error: "' + g.description + '" (' + g.code + ")") : g.code !== $.xmo.err.XMO_REQUEST_NO_ERR && 
$.xmo.logger.error('XMO getValue request error: "' + g.description + '" (' + g.code + ")")
        } else {
